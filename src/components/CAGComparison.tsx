...
export default function CAGComparison() {
    return (
        <section id="cag-comparison" className="py-12 sm:py-16 md:py-24 px-3 sm:px-4 relative overflow-hidden">
            <div className="max-w-6xl mx-auto relative z-10">
                ...
                >
                    <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold mb-3 sm:mb-4 md:mb-6 px-2" style={{ color: 'var(--foreground)' }}>
                ...
                <div className="grid md:grid-cols-2 gap-4 sm:gap-6 md:gap-8">
                    ...
                    <motion.div
                        ...
                        className="rounded-xl sm:rounded-2xl p-4 sm:p-6 md:p-8 backdrop-blur-sm hover:opacity-80 transition-all cursor-default"
                    >
                        <div className="flex items-center gap-2 sm:gap-3 mb-4 sm:mb-6 md:mb-8">
                            <div className="p-2 sm:p-3 rounded-lg" style={{ background: 'var(--border)' }}>
                                <Database className="w-4 h-4 sm:w-5 sm:h-5 md:w-6 md:h-6" style={{ color: 'var(--muted)' }} />
                            </div>
                            <h3 className="text-lg sm:text-xl md:text-2xl font-semibold" style={{ color: 'var(--foreground)' }}>Traditional RAG</h3>
                        </div>
                    ...
                    <motion.div
                        ...
                        className="border rounded-xl sm:rounded-2xl p-4 sm:p-6 md:p-8 backdrop-blur-sm relative overflow-hidden hover:opacity-100 transition-all cursor-default"
                    >
                        <div className="absolute top-0 right-0 w-24 h-24 sm:w-32 sm:h-32 bg-white/10 blur-[50px] rounded-full" />

                        <div className="flex items-center gap-2 sm:gap-3 mb-4 sm:mb-6 md:mb-8">
                            <div className="p-2 sm:p-3 rounded-lg" style={{ background: 'rgba(255,255,255,0.2)' }}>
                                <Brain className="w-4 h-4 sm:w-5 sm:h-5 md:w-6 md:h-6 text-white" />
                            </div>
                            <h3 className="text-lg sm:text-xl md:text-2xl font-semibold text-white">RepoInfo (CAG)</h3>
                        </div>
